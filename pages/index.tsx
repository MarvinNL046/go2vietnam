...
const travelEssentials = [
  {
    href: '/visa/',
    title: 'Visa Guide',
    description: 'E-visa, visa on arrival, exemptions, and step-by-step application help.',
    icon: (
  ...
  },
  {
    href: '/transport/',
    title: 'Transport',
    description: 'Trains, buses, flights, and motorbike tips to get around like a local.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Best time to visit, regional climates, and what to pack each month.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Currency, tipping, power outlets, safety, and cultural etiquette tips.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    href: '/esim/',
    title: 'eSIM & Internet',
    description: 'Stay connected with the best eSIM and SIM card options for travelers.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Compare plans and find the right coverage for your Vietnam adventure.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <section className="section-padding bg-white">
          <div className="container-custom">
            <div className="section-header">
              ...
              <p className="section-subtitle">
                Savor the iconic flavors of {siteConfig.destination} — from street stalls to local favorites
              </p>
            </div>
      ...
      {drinks.length > 0 && (
        <section className="section-padding bg-warm-50">
          <div className="container-custom">
            <div className="section-header">
              <h2 className="section-title">
                Must-Try {siteConfig.destination}ese Drinks
              </h2>
              <p className="section-subtitle">
                    ...
                    <div className="flex items-center gap-4 p-5">
                      <div className="relative w-20 h-20 flex-shrink-0 rounded-xl overflow-hidden">
                        <img
                          ...
                          alt={drink.name?.en || drink.name || drink.slug}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-display font-bold text-lg text-warm-900 truncate">
                            {drink.name?.en || drink.name || drink.slug}
                          </h3>
                          {drink.category && (
                        ...
                        {(drink.description?.en || drink.description) && (
      ...
      {islands.length > 0 && (
        <section className="section-padding bg-white">
          <div className="container-custom">
            <div className="section-header">
              <h2 className="section-title">
                {siteConfig.destination}&apos;s Beautiful Islands
              </h2>
              <p className="section-subtitle">
      ...
      <section className="section-padding bg-warm-50">
        <div className="container-custom">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Everything you need to plan and prepare for your {siteConfig.destination} trip
            </p>
          </div>
          <div className="animate-stagger grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
      ...
      <section className="relative bg-brand-secondary-900 bg-hero-pattern py-20 lg:py-28 overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center max-w-3xl">
          ...
          <p className="text-warm-400 text-lg mb-10 max-w-xl mx-auto">
            From bustling cities and pristine islands to incredible street food — plan your perfect trip with our comprehensive guides and local insights.
          </p>
