      ...
      <div className="container-custom py-8 lg:py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-warm-500 text-lg">
            Savor authentic flavors and must-try local dishes
          </p>
        </div>
        ...
        {dishes.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-warm-500 text-lg font-medium mb-2">No dishes yet</p>
            <p className="text-warm-400 text-sm">Content coming soon! We are working on adding local dishes.</p>
          </div>
        ) : (
